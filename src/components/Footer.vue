...
const faqItems = [
    ...
    answer: 'Для заказа свяжитесь с нами через Telegram, нажав кнопку "Связаться с нами", или купите товар на avito. Мы ответим в ближайшее время и поможем выбрать идеальный амариллис для вас.'
  },
  {
